...
public:
  ...
  inline index_t index() const { return index; }
  inline index_t gen() const { return gen; }
  inline void *index_as_void() const { return static_cast<void *>(index); };
  ...
  inline explicit bool operator() const { return generation != 0; }
